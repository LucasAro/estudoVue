...
ComponentsLoader::load([Input::class]);
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>VueInput - Documentação PhpVue</title>
...
<body>
    <div id="app" class="container">
        <div class="header">
            <h1>VueInput</h1>
            <div class="component-tag">&lt;vue-input&gt;</div>
            <p>Input.php - Componente Vue Input com label opcional, botão de limpar e slots</p>
        ...
        <div class="section">
            ...
            <tr>
                ...
                <th>Descrição</th>
                    ...
                    <td>id </td>
                    <td>String</td>
                    <td><code>() => `input-${Math.random().toString(36).substring(2, 9)}`</code></td>
                    <td></td>
                </tr><tr>
        ...
        <div class="section">
            ...
            <tr>
                ...
                <td>label</td>
                <td>Substitui o label padrão do input.</td>
            </tr><tr>
                <td>prefix</td>
                <td>Conteúdo a ser exibido antes do campo de input (ícones, etc).</td>
            </tr><tr>
                <td>input</td>
                <td>Substitui o campo de input padrão completamente.</td>
            </tr><tr>
                <td>clear-button</td>
                <td>Substitui o botão de limpar padrão.</td>
            </tr><tr>
                <td>suffix</td>
                <td>Conteúdo a ser exibido após o campo de input (ícones, unidades, etc).</td>
            </tr><tr>
                <td>helper</td>
                <td>Conteúdo a ser exibido abaixo do input (textos de ajuda, mensagens de erro, etc).</td>
            </tr></table>
        </div>
        ...
        <div class="section">
            ...
            <tr>
                ...
                <td>clear</td>
                <td>Emitido quando o conteúdo é limpo.</td>
            </tr></table>
        </div>
...
&lt;/script&gt;</code></pre>
        ...
        <div class="section">
            <h2>Estilos CSS</h2>
            <pre><code class="language-css">.vue-input-wrapper {\n    margin-bottom: 15px;\n    position: relative;\n\n}\n\n.vue-input-label {\n    display: block;\n    font-size: 14px;\n    font-weight: 600;\n    margin-bottom: 6px;\n    color: #333;\n    text-align: left;\n\n}\n\n.required-mark {\n    color: #dc3545;\n    margin-left: 3px;\n\n}\n\n.vue-input-container {\n    position: relative;\n    display: flex;\n    align-items: center;\n\n}\n\n.vue-input {\n    width: 100%;\n    padding: 10px 35px 10px 12px;\n    border: 1px solid #ddd;\n    border-radius: 4px;\n    font-size: 16px;\n    line-height: 1.5;\n    transition: border 0.2s ease;\n    box-sizing: border-box;\n\n}\n\n.vue-input:focus {\n    outline: none;\n    border-color: #ffc107;\n    box-shadow: 0 0 0 3px rgba(255, 193, 7, 0.25);\n\n}\n\n.vue-input:disabled {\n    background-color: #f8f9fa;\n    cursor: not-allowed;\n\n}\n\n.clear-button {\n    position: absolute;\n    right: 10px;\n    background: none;\n    border: none;\n    cursor: pointer;\n    color: #999;\n    font-size: 14px;\n    padding: 5px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    transition: color 0.2s ease;\n\n}\n\n.clear-button:hover {\n    color: #dc3545;\n\n}\n\n</code></pre>
        </div>
    </div>
